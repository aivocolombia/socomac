  ...
  #TODO Fixear maximo 4 respuestas sin imagenes, y si hay imagenes no hay limite de respuestas pero omptimizar por preguntas filtro al usuario.
    def formatear_json(self, texto: str) -> dict:
        ...
        prompt = (
            ...
            "   - **CRÍTICO**: Si el texto es un resumen de operación o confirmación (contiene '📋 Resumen', '🔧 Acción', '💰 Saldo', '¿Confirmas'), MANTÉNLO TODO EN UN SOLO MENSAJE\n"
            "   - **CRÍTICO**: Si el texto es una pregunta de confirmación, MANTÉNLA EN EL MISMO MENSAJE que el resumen\n"
            ...
            "]\n\n"
            "4. EJEMPLO DE RESUMEN DE OPERACIÓN (DEBE IR EN UN SOLO MENSAJE):\n"
            "[\n"
            "  { \"message\": \"📋 Resumen de la operación:\\n🔧 Acción: Abrir conciliaciones\\n💰 Saldo Davivienda: $100\\n💰 Saldo Bancolombia: $200\\n\\n¿Confirmas realizar esta operación?\" }\n"
            "]\n\n"
