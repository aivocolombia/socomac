...
- obtener_telefonos_administradores(): Obtiene números de teléfono de usuarios administradores
...
7. Consultar números de administradores: Si el usuario pregunta por números de teléfono autorizados o administradores, usa obtener_telefonos_administradores() para obtener los números desde la tabla user_agent donde type = "Administrador".
